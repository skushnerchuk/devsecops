...
| 2    | Отсутствует проверка входных данных при регистрации/авторизации пользователя. | CWE-20: Improper Input Validation<br />CWE-521: Weak Password Requirements |                                                 | Проверка корректности входных данных в имени пользователя, адресе электронной почты и пароле. |
