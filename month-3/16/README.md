...
Посмотрим список образов, которые есть на данный момент (на скриншоте некоторые скрыты некоторые служебные образы):
...
Посмотри, отличаются ли пользователи хоста и образа. Для этого выполним последовательно команду `whoami` сначала на хостовой машине, потом - в запущенном образе. 
